...
void CmpBasicModelRender::update_animation(int milliseconds)
{
	...
	if(cmpAnimChooser) m_animController->request_animation(cmpAnimChooser->choose_animation());
