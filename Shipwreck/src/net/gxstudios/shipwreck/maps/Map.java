...
import net.gxstudios.shipwreck.brushes.BrushDetails;
...
import net.gxstudios.shipwreck.event.ISelectionListener;
import net.gxstudios.shipwreck.event.RepaintListenerComposite;
