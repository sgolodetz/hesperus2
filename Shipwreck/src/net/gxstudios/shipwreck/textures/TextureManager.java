...
public class TextureManager implements TextureConstants
{
	...
	//################## PRIVATE VARIABLES ##################//
	// Note: We could use HashMap here instead, but it's nice to be able to retrieve an
	// ordered list of texture names in {@link net.gxstudios.shipwreck.gui.TextureDialog}.
	// It's generally more efficient to use HashMap, so we might need to reconsider this
