...
/**
This specifies an interface for anything that can be repainted. Good examples of things
which can be repainted include a {@link net.gxstudios.shipwreck.gui.DesignCanvas}.
*/
